...
typedef enum ISYSWarningMode
{
    ISYS_TEMPERATURE_WARNING = 0,
    ISYS_RANGE_WARNING
}iSYSWarningMode_t;

typedef enum iSYSTargetListInterface
{
    ISYS_TARGETLIST_IF_DISABLE = 0,
    ISYS_TARGETLIST_IF_SPI = 1,
    ISYS_TARGETLIST_IF_ETH = 2,
    ISYS_TARGETLIST_IF_END
}iSYSTargetListInterface_t;

typedef enum iSYSLedConfiguration
{
    ISYS_LED_CONFIG_OFF = 0,
    ISYS_LED_CONFIG_ON = 1,
    ISYS_LED_CONFIG_DISABLE_BLINKING = 2,
    ISYS_LED_CONFIG_END
}iSYSLedConfiguration_t;
